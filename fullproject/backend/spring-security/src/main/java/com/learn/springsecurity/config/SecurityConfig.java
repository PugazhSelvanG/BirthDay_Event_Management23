...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.addAllowedOrigin("http://localhost:5173"); // Add your frontend origin
        // corsConfiguration.addAllowedOrigin("http://localhost:3000"); // Add any other origins if needed
        corsConfiguration.addAllowedHeader("Content-Type"); // Add any other headers if needed
        corsConfiguration.addAllowedMethod("OPTIONS"); // Add any other methods if needed
